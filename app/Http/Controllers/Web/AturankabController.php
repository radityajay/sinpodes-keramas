...
class AturankabController extends Controller
{
    /**
    ...
    {
        $data = RegionRule::orderBy('created_at','asc')->get();
        // dd($data);
        return view('web.aturankabupaten', [
            'data' => $data
        ]);
    }
    ...
    public function filter(Request $request){
        // dd($request->all());
        $data = RegionRule::when(($request->start_date != null && $request->start_date != '')
