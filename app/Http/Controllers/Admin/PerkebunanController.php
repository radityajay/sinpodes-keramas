...
class PerkebunanController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->type == 'datatable') {
            $data = Perkebunan::orderBy('created_at', 'desc');
    ...
    {
        return view('admin.perkebunan.form');
    }
    ...
    {
        $oldPhoto = Perkebunan::where('id', $id)->orderBy('created_at', 'desc')->first();
