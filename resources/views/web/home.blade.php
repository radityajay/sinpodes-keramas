                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="col-wrap">
                                        <div class="ico-box bg-gray-light has-radius-medium">
                                            <div class="icon">
                                                <span class="custom-icon-pen-tool"><span
                                            ...
                                            <div class="post-grid reverse-grid">
                                                ...
                                                <div class="img-block post-img">
                                                    @foreach ($item->images as $index => $value)
                                                        @if ($index == 0)
                                                        <a href="#"><img src="{{ $value->photo_url }}" class="img-tl" alt="images"></a>
                                                        @endif
                                                    @endforeach
                                                ...
                                                <div class="post-text-block bg-gray-light">
                                                    <strong class="content-title mb-0"><a href="">{{ $item->title }}</a></strong>
                                                    ...
                                                    <div class="post-meta clearfix">
                                                        <div class="post-link-holder">
                                                            <a href="#">Selengkapnya <span class="fa fa-arrow-right"><span class="sr-only">&nbsp;</span></span></a>
                                                        </div>
