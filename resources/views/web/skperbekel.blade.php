        ...
        <div class="visual-inner blog-default-banner dark-overlay parallax" data-stellar-background-ratio="0.55">
            <div class="container">
                <div class="visual-text-large text-left visual-center">
                    <h1 class="visual-title visual-sub-title">SK Perbekel</h1>
    ...
    let app = new Vue({
        ...
        mounted(){
            ...
            $('#btn-filter').on('click', function(){
                $.ajax({ 
                    type: "GET",
                    url: '/filter-skperbekel?start_date='+ self.filter.start_date +'&end_date='+ self.filter.end_date,
                    data: {
                        "_token": "{{ csrf_token() }}",
                    },
        ...
        methods:{
            btnFilter(){
                ...
                $.ajax({ 
                    type: "GET",
                    url: '/filter-skperbekel?start_date='+ this.filter.start_date +'&end_date='+ this.filter.end_date,
                    data: {
                        "_token": "{{ csrf_token() }}",
                    },
                    success: function (response) {
