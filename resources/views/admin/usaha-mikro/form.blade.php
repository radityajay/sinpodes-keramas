...
@if(!isset($data))
@section('title', 'Tambah UsahaMikro')
@else
@section('title', 'Edit UsahaMikro')
@endif
...
<div class="container-fluid">
        ...
        <div class="col-md-10">
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('usaha-mikro.index') }}">UsahaMikro</a></li>
                    @if(!isset($data))
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form id="submits" action="{{ !isset($data) ? route('usaha-mikro.store') : route('usaha-mikro.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @isset($data)
                        @method('PUT')
                        @endisset
                        ...
                        <div class="col-md-12">
                            <div class="form-group" style="float: right">
                                <a href="{{ route('usaha-mikro.index') }}" class="btn btn-light"><i class="ri-arrow-left-line"></i> Kembali</a>
